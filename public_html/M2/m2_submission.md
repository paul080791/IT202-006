...
<tr><td> <em>Generated: </em> 2/15/2022 1:54:30 AM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-006-S22/m2-php-hw/grade/psg4" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/78453577/154006878-e36f26b6-af6d-4938-a832-e43f9ef88280.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Using foreach and conditional to get odd numbers<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I use math operator % to get the reminder, apply if conditional to<br>check if the reminder of value % 2 is equal to 1 print<br>the Odd value<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/78453577/154007286-9ba0a3c1-9b1f-4914-88f8-d390dd7b1eea.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Get Sum of values of an array<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>In a FOREACH loop, get the total sum of the values of the<br>array. <br>To get the round part, I use number_format($total,2), It gives me only<br>2 decimals.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/78453577/154007585-80bb5da4-8c7d-4fef-b37c-f59479689ab3.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Output of positive numbers<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I use a foreach loop to go through the array <br>Check if the<br>values are numbers(this case just int) with the this operator === <br>if is<br>a string then cast as interger $num=(int)$valueofarray;<br>then check is if is more than<br>0 or less and print the positive number .<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://psg4-prod.herokuapp.com/M2/problem1.php">https://psg4-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://psg4-prod.herokuapp.com/M2/problem2.php">https://psg4-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://psg4-prod.herokuapp.com/M2/problem3.php">https://psg4-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
