CREATE TABLE IF NOT EXISTS RM_Items(
    ...
    name varchar(40) UNIQUE, -- alternatively you'd have a SKU that's unique
    description text,
    category text,
    stock int DEFAULT  0,
    cost DECIMAL(18,2) DEFAULT 0.00, -- my cost is int because I don't have regular currency; shop people may want to record it as pennies
