...
//JOIN OrderItems oi ON oi.order_id = o.id JOIN RM_Items item on oi.item_id=item.id
//$base_query="SELECT  id, user_id, money_received, address, payment_method FROM Orders ";
//$total_query = "SELECT count(1) as total FROM Orders o ";// I change items for orders
...
//$stmt = $db->prepare("SELECT  id, user_id, money_received, address, payment_method FROM Orders   WHERE user_id = :id LIMIT 10");
